...
from .level_final_ui import Ui_MainWindow
from PyQt5.QtCore import Qt


class LevelFinal(QMainWindow, Ui_MainWindow):

    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.filepath = 'resources/level/level_final/'
    ...
    def next(self):
        ...
        if self.num + 1 < self.max_num:
            ...
            self.show()
            # 播放音乐
            self.bell = QSound('resources/music/level_final.wav')
            self.bell.play()
